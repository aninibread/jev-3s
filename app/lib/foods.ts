...
export const foods: Food[] = [
  ...
  },
  {
    ...
    name: "Cheesecake",
    description:
      "A slice of cheesecake made of dense cheese filling resting on a distinct crumb crust base.",
    image: "/foods/cheesecake.webp",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Cheesecake_with_slice_cut_out.jpg",
    creator: "Martin van Dam",
    license: "CC BY 2.0",
    licenseUrl: "https://creativecommons.org/licenses/by/2.0",
    attribution: "Cheesecake — Martin van Dam (CC BY 2.0)",
  ...
  },
  {
    ...
    name: "Avocado toast",
    description:
      "Mashed avocado and a poached egg resting on one slice of toasted sourdough bread.",
    image: "/foods/avocado-toast.webp",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Avocado_toast_with_eggs_(28508171495).jpg",
    creator: "Luca Nebuloni",
    license: "CC BY 2.0",
    licenseUrl: "https://creativecommons.org/licenses/by/2.0",
    attribution: "Avocado toast — Luca Nebuloni (CC BY 2.0)",
    modifications: "Resized, cropped and converted to WebP.",
    debatable: true,
  },
  {
    ...
    description:
      "Creamy chicken and vegetables enclosed by a baked pastry crust, with no free-flowing broth.",
    image: "/foods/chicken-pot-pie.webp",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Chicken_Pot_Pie,_cut_open.jpg",
    creator: "MonicaVereanaWilliams",
    license: "CC BY-SA 4.0",
    licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0",
    attribution: "Chicken pot pie — MonicaVereanaWilliams (CC BY-SA 4.0)",
    modifications: "Resized, cropped and converted to WebP.",
    debatable: true,
  },
  {
    ...
    name: "Berry smoothie",
    description:
      "A thick blended drink made from berries and liquid, served without solid toppings.",
    image: "/foods/berry-smoothie.webp",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Berry_smoothie_on_a_planterbox.jpg",
    creator: "Miscellaneous contributor",
    license: "CC0",
    licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/",
    attribution: "Berry smoothie — Miscellaneous contributor (CC0)",
    modifications: "Resized, cropped and converted to WebP.",
    debatable: true,
  },
  {
    ...
    name: "Loaded fries",
    description:
      "A loose pile of french fries topped with melted cheese, tomato, scallions and sour cream.",
    image: "/foods/loaded-fries.webp",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Loaded_fries_food.jpg",
    creator: "Luke",
    license: "Public domain",
    licenseUrl: "https://commons.wikimedia.org/wiki/File:Loaded_fries_food.jpg",
    attribution: "Loaded fries — Luke (Public domain)",
    modifications: "Resized, cropped and converted to WebP.",
    debatable: true,
  },
  {
    id: "salmon-nigiri",
    name: "Salmon nigiri",
    description: "Slices of raw salmon resting on compact shaped rice bases.",
    image: "/foods/salmon-nigiri.webp",
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Salmon_Nigiri_Sushi,_2008.jpg",
    creator: "www.bluewaikiki.com",
    license: "CC BY 2.0",
    licenseUrl: "https://creativecommons.org/licenses/by/2.0",
    attribution: "Salmon nigiri — www.bluewaikiki.com (CC BY 2.0)",
    modifications: "Resized, cropped and converted to WebP.",
    debatable: true,
  },
  {
