...
export const DOG_RULES_VERSION = "1";
...
export const dogClassificationRules = {
  ...
  pig:
    "A pig-like dog: compact, broad, stocky, barrel-bodied or notably low and sturdy, often with a blunt short muzzle, broad face, wrinkles or heavy jowls. Includes bulldogs, pugs and corgis.",
  rat:
